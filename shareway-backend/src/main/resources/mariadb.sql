...
'$2y$10$99tNYcUFLY50W5/aZzQRt.odz0nJAkVlM/xyLh4S/s/AydV/5XEUu', 'USER'),
...
VALUES
(3, 'Zaragoza', 'Madrid', '2026-05-20', 'CAR', 3, 25, false),
(4, 'Barcelona', 'Valencia', '2026-05-22', 'TRAIN', 5, 40, false),
(5, 'Sevilla', 'Málaga', '2026-05-25', 'BUS', 1, 15, true),
(6, 'Bilbao', 'Santander', '2026-05-28', 'CAR', 2, 18, false),
(7, 'Zaragoza', 'Barcelona', '2026-06-01', 'CAR', 1, 20, false);
